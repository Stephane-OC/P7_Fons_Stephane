...
function tagManager() {
  ...
  // Display number of recipes after filtering by tag
...
function mainSearchBarFilter() {
  ...
  console.log(
    "Nombre de recettes après filtrage par tag:",
  ...
  if (searchFilteredRecipes.length == 0) {
    searchMessage.textContent =
      "Aucune recette ne correspond à votre critère, veuillez réessayer...";
